...
import { TCourse, TOfferedCourse, TSemisterRegistration } from "../../../../types/coursesManagement";
...
const CourseManagementApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getAllAssignCourseFaculty: builder.query({
      query: (id) => {
...
export const {
  ...
  useAddOfferedCoursMutation, useGetAllOfferCourseQuery,useGetAllAssignCourseFacultyQuery
} = CourseManagementApi;